...
(function() {
    ...
    Game_Player.prototype.validLanding = function(x, y) { return this.canJumpTo(x, y); };
    ...
    Game_Player.prototype.updateFly = function() {
        ...
        f.bobTimer += 0.08; f.bobOffset = Math.sin(f.bobTimer) * 8;
        if (this.isFlyBlocked(this._x, this._y)) this.endFly();
    };

    Game_Player.prototype.getFlyOffsetY = function() {
        return this._fly.active ? (-P.flyHeight + this._fly.bobOffset) : 0;
    };
