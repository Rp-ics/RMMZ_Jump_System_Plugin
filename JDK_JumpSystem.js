 ...
 * @command allowFly
 * @text Allow Fly
 * @desc Allow the player to use fly mode (key works)
 *
 * @command disallowFly
 * @text Disallow Fly
 * @desc Disallow the player from using fly mode (key does nothing)
 *
 * @command enableFly
 * @text Enable Fly
 * @desc Start flying now
 *
 * @command disableFly
 * @text Disable Fly
 * @desc Stop flying now
 *
 * @command toggleFly
 * @text Toggle Fly
...
(function() {
    ...
    window.JDKJump = {
        ...
        fly: {
            allow: function() { $gameTemp._flyEnabled = true; },
            disallow: function() { $gameTemp._flyEnabled = false; $gamePlayer.endFly(); },
            ...
            isAllowed: function() { return $gamePlayer.flyEnabled(); }
        }
    };
    ...
    PluginManager.registerCommand('JDK_JumpSystem', 'allowFly', function() { $gameTemp._flyEnabled = true; });
    PluginManager.registerCommand('JDK_JumpSystem', 'disallowFly', function() { $gameTemp._flyEnabled = false; $gamePlayer.endFly(); });
